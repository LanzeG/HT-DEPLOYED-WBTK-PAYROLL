...
<div class="row mt-3 mb-1 d-flex justify-content-end  ">
  <div class="col-12">
    <div class="buttons  ">
      <a href="../../ADMIN/REPORTS/printsss.php?printAll" class="inline-block bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md border border-green-500 hover:border-green-600 transition duration-300 ease-in-out mr-1" target="_blank"><i class="fas fa-print mr-2"></i> Print All Masterlist</a>
      <a href="../../ADMIN/REPORTS/printsss.php?printDisplayed" class="inline-block bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md border border-green-500 hover:border-green-600 transition duration-300 ease-in-out mr-1" target="_blank"><i class="fas fa-print mr-2"></i> Print Displayed Masterlist</a>
    ...
    vertical-align: middle; /* You can change this to 'top' or 'bottom' based on your preference */
        ...
        <?php
          function filterTable($searchquery){
            $conn = mysqli_connect("localhost", "u387373332_masterdb", "WBTKpayrollportal1234@", "u387373332_masterdb");
        ...
        ?>
            <tr class="gradeX">
              ...
              <td><?php echo $row1DEPT['empfirstname']; ?></td>
               ...
               <td>
                <?php
                  if ($row1DEPT['status']=='On-Going'){
                ?>
                <button onclick="stopLoan('<?php echo $row1DEPT['uniquekey']; ?>','<?php echo $adminFullName ?>')" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
                  Stop
                </button>
                <?php
                  }else{
