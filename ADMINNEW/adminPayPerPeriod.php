...
if (isset($_GET['refresh'])) {
  header("Location: adminPayperPeriod.php");
  exit();
}
...
if (empty($search_result)) {
  $start_from = ($page - 1) * $results_perpage;
  $searchquery = "SELECT * FROM employees,PAY_PER_PERIOD WHERE employees.emp_id = PAY_PER_PERIOD.emp_id";
  $_SESSION['printpayroll_query'] = $searchquery;
  ...
  <div class="table d-flex align-items-center table-responsive">
    <table class="table table-striped">
      <thead class="table-striped" style="background-color: #2ff29e; color: #4929aa;">
        <tr>
          <th style="border-top-left-radius: 10px; color: #4929aa;">Payroll Period</th>
          <th>Employee ID</th>
          ...
          <th>Disallowance</th>
          <th>First Half</th>
          <th style="border-top-right-radius: 10px; color: #4929aa;">Second Half</th>
...
<?php
  ...
  $ref = $row1['undertimehours'] + $row1['absences']
?>
  <tr class="gradeX">
  <td>
    ...
    <td>
      <center>
        <?php echo $row1['reg_pay']; ?>
    </td>

    <td>
      <center>
        <?php echo $row1['rate_per_hour']; ?>
    </td>
    <td>
      <center>
        <?php echo $row1['net_pay']; ?>
    </td>
    <td>
      <center>
    ...
    <td>
      <center>
        <?php echo $row1['philhealth_deduct']; ?>
    </td>
    <td>
      <center>
        <?php echo $row1['pagibig_deduct']; ?>
    </td>
    <td>
      <center>
        <?php echo $row1['tax_deduct']; ?>
    </td>
    <td>
      <center>
        <?php echo $row1['loan_deduct']; ?>
    </td>

    <td>
      <center>
      <?php echo number_format($row1['undertimehours'] + $row1['absences'], 2); ?>
    ...
    <td>
      <center>
        <?php echo $row1['firsthalf']; ?>
    </td>
    <td>
      <center>
        <?php echo $row1['secondhalf']; ?>
    </td>
  </tr>
    <?php endwhile; ?>
  </tbody>
