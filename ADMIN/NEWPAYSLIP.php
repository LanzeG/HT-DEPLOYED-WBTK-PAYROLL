...
$pdf->Cell(50,3,$dept,0,0);//end of line
...
$pdf->Cell(136,3,$position,0,0);//end of line
...
$pdf->Cell(123,3,'----------------------------------------------------------------------------------------------------------------------------------------------------',0,0); // Adjust separator as needed
...
$pdf->Cell(118,3,'----------------------------------------------------------------------------------------------------------------------------------------------',0,0); // Adjusted separator width
...
$pdf->Cell(6,5,'',0,0);
	...
	$pdf->Cell(15,1,$adminFullName,0,1);//end of line
